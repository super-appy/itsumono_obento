...
当アプリの最大の特徴は、**食材を余すことなく使える**という点です。使いたい材料(最大で3つ)、料理のテイスト、調理時間の3つが入力されると、お弁当におすすめのレシピをAIで生成し表示します。生成されたレシピは材料でタグ付けされて蓄積されていくため、レシピ一覧から他の人が生成した同じ材料を使ったレシピを検索して参考にすることもできます。  
この機能により、適切なレシピが提案されることで忙しい朝の時間を節約することができます。また、家にある食材を無駄なく使い切ることができるため食費の節約にもなります。
...
## ER図
[![Image from Gyazo](https://i.gyazo.com/8eb37530ea3a0de12ff61e0ee256f0e5.png)](https://gyazo.com/8eb37530ea3a0de12ff61e0ee256f0e5)