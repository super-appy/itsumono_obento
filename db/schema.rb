...
ActiveRecord::Schema[7.0].define(version: 2023_12_30_014700) do
  ...
  create_table "like_lunchbox_logs", force: :cascade do |t|
    ...
    t.index ["user_id", "lunchbox_log_id"], name: "index_like_lunchbox_logs_on_user_id_and_lunchbox_log_id", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.string "avator"
    t.integer "line_registerd", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "salt"
